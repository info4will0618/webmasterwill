...
<body id="body">
	...
	<div id="subscriber-pop_cover">
		<?php include(MyHelpers::UrlContent('~/views/blog/components/subscribe_pop.php')); ?>
	</div>
		...
		<div id="middle">
			...
			<?php 
				 ...
				 $path = $_SERVER['REQUEST_URI'];
       			 ...
       			 if (count($parts) > 1) {
           			include(MyHelpers::UrlContent('~/views/shared/components/_breadcrums.php'));
        		 }
