...
<?php endif ?>
 <p id="blog-subscriber_description">
	Get the latest information on Web Development and how to use it to obtain success: 
</p>
<div class="flex-container" id="subscription-flex-container">
	...
	<form action="<?php echo $cfg['site']['root']; ?>/subscribe" method='POST' id="subscribe-form">
		<div class="subscribe-form_input">  
			...
			<?php if(isset($_SESSION['subscribe-errors']['user-exist'])): ?>
				<p class="subscriber-error">
					...
					<span style="color: black;"><?php echo $_SESSION['subscribe-errors']['user-exist']; ?>.</span>
	    ...
	    <div id="subscribe-blog_button" class="button-1"> 
	        <input type='submit' value='Get the latest valuable info!' name="subscribe"  /> 
